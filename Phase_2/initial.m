...
RRV.R1 = sqrt(body.m*g/4/body.b) + 0.01;
RRV.R2 = sqrt(body.m*g/4/body.b);
RRV.R3 = sqrt(body.m*g/4/body.b) - 0.01;
...
Initial_Conditions = [chi0.x;chi0.y;chi0.z;
                      lambda0.phi;lambda0.theta;lambda0.psi;
                      v0.x;v0.y;v0.z;
                      omega0.p;omega0.q;omega0.r];